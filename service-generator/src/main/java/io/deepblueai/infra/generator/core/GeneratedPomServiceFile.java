 ...
 * @date 2017/11/10
 */
public class GeneratedPomServiceFile extends AbstractGeneratedFile {

  private PomModel model;

  private String fileName;

  public GeneratedPomServiceFile(GeneratorParam generatorParam) {
