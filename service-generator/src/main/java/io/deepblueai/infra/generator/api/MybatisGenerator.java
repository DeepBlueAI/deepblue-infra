...
import io.deepblueai.infra.generator.core.MybatisProgressCallback;
import io.deepblueai.infra.generator.core.MybatisShellCallback;
import io.deepblueai.infra.generator.model.*;
import io.deepblueai.infra.generator.util.DatabaseTool;
...
public class MybatisGenerator implements Generator {
  ...
  private String mapperBaseClass = "io.deepblueai.base.mapper.CommonMapper";
  ...
  private void generateModelAndMapper(GeneratorParam generatorParam, TableInfo tableInfo) throws Exception {
    ...
    // 增加@Repository注解
    pluginConfiguration.setConfigurationType("io.deepblueai.infra.generator.core.MybatisMapperPlugin");
...
//        pluginConfiguration.addProperty("mappers", basicClassName);
    ...
    if (ServiceType.BASIC.equals(generatorParam.getProjectInfo().getServiceType())) {
      ...
      actualPath = rootDir.concat("/").concat(aid);
    }
    javaModelGeneratorConfiguration.setTargetProject(actualPath + "/" + javaPath);
...
//        }
    ...
    sqlMapGeneratorConfiguration.setTargetProject(actualPath + "/" + resourcePath);
    sqlMapGeneratorConfiguration.setTargetPackage("mapper");
    context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);

    // JAVA Mapper类
    JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
    javaClientGeneratorConfiguration.setTargetProject(actualPath + "/" + javaPath);
