 ...
 * @date 2017/09/26
 */
public class GeneratedJavaReqSearchClass extends AbstractGeneratedJavaDatabaseClass {
   ...
   * @param tableInfo
   */
  public GeneratedJavaReqSearchClass(GeneratorParam generatorParam, TableInfo tableInfo) {
