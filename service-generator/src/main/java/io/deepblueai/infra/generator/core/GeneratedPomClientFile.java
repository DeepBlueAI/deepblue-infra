 ...
 * @date 2017/11/10
 */
public class GeneratedPomClientFile extends AbstractGeneratedFile {

  private PomModel model;

  private String fileName;

  public GeneratedPomClientFile(GeneratorParam generatorParam) {
    ...
    fileName = buildActualDir("", true).concat("/").concat("pom.xml");
