 ...
 * @date 2017/09/28
 */
public class GeneratedJavaReqCreateClass extends AbstractGeneratedJavaDatabaseClass {
   ...
   * @param tableInfo
   */
  public GeneratedJavaReqCreateClass(GeneratorParam generatorParam, TableInfo tableInfo) {
