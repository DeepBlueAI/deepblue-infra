 ...
 * @date 2017/09/26
 */
public class GeneratedJavaRespSingleClass extends AbstractGeneratedJavaDatabaseClass {
   ...
   * @param tableInfo
   */
  public GeneratedJavaRespSingleClass(GeneratorParam generatorParam, TableInfo tableInfo) {
