...
public abstract class AbstractGeneratedJavaClass extends AbstractGeneratedFile {
  ...
  public AbstractGeneratedJavaClass(GeneratorParam generatorParam, TableInfo tableInfo, boolean isClient) {
    ...
    fileName = buildActualDir(javaPath, isClient).concat("/").concat(packagePath).concat("/") + className + ".java";
  }
